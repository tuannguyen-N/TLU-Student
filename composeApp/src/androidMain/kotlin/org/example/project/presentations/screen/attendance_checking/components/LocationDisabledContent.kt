...
fun LocationDisabledContent(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = "Ứng dụng cần xác minh vị trí của bạn để đảm bảo bạn đang trong phạm vi điểm danh cho phép. Vui lòng bật GPS trên thiết bị.",
